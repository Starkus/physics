...
set CompilerFlags=-MTd -nologo -Gm- -GR- -Oi -EHa- -W4 -wd4201 -wd4100 -wd4996 -wd4063 -FC -Z7 -I ..\external\ -DIS_MSVC=1 -std:c++20
set LinkerFlags=-opt:ref -incremental:no -debug:full
set Libraries=user32.lib winmm.lib shell32.lib opengl32.lib
