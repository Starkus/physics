...
inline f32 Sign(f32 n)
{
	...
	asF32 = n;
	return (asU32 & 0x80000000) ? -1.0f : 1.0f;
#else
...
inline bool V3EqualWithEpsilon(const v3 &a, const v3 &b, f32 epsilon)
{
	return EqualWithEpsilon(a.x, b.x, epsilon) &&
		   EqualWithEpsilon(a.y, b.y, epsilon) &&
		   EqualWithEpsilon(a.z, b.z, epsilon);
}
...
inline v3 Mat4ColumnV3(const mat4& m, s32 column)
{
	return v3
	{
		m.m[column],
...
inline v4 Mat4ColumnV4(const mat4& m, s32 column)
{
	return v4
	{
		m.m[column],
