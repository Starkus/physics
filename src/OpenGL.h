...
typedef void (GLAPIENTRY *glDrawBufferProc)(GLenum mode);
typedef void (GLAPIENTRY *glReadBufferProc)(GLenum mode);
...
GL_DeclareProc(glDrawBuffer);
GL_DeclareProc(glReadBuffer);
...
#define GL_GetProc(name) name = ((name##Proc) GL_GetProcAddress(#name))
	...
	GL_GetProc(glDrawBuffer);
	GL_GetProc(glReadBuffer);
